...
export class SpeechService implements OnDestroy {
    ...
    init() {
        ...
        // this.recognition = <any>(new SpeechRecognition());
    ...
    declareCommand(command:any, context:any): void {
    ...
    private setGrammar(): void {
        var SpeechGrammarList = 'SpeechGrammarList' in window || 'webkitSpeechGrammarList' in window;
